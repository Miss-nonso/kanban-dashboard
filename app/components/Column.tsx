...
const Column = ({ column }: ColumnType) => {
  ...
  return (
    <div className="column-wrapper" style={style} ref={setNodeRef} {...attributes} {...listeners}>
      <SortableContext items={tasksId} id={column._id} strategy={verticalListSortingStrategy}>
